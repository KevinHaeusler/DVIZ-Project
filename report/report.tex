...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{/mnt/dev/Projects/DVIZ-Project/images/shodan-search-results}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{/mnt/dev/Projects/DVIZ-Project/images/shodan-download-page}
...
\begin{figure}[!htb]
    \centering
    \includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{/mnt/dev/Projects/DVIZ-Project/images/downloaded-archive}
...
\begin{figure}[h!]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/32k-dataset-na-entries}
...
\begin{figure}[h!]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/9k-dataset-na-entries}
...
\begin{figure}[h!]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/digital-assets-ag-rotkreuz-ch-search}
...
\begin{figure}[h!]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/shodan-digital-assets-ag}
...
\begin{figure}[!h]
    \centering
    \includegraphics[keepasprectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/product-piechart}
    \caption{Product Pie Chart}
    \label{fig:product-piechart}
\end{figure}

A simple Pie Chart that regexes things like web/nginx/apache/httpd for web and other keywords for other categories lets us see
which Products are commonly used. Mail and Web are obviously used the most because they have to be publicly accessible to function.
...
\begin{figure}[!h]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/port-53-distribution-by-isp}
