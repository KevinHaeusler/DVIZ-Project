...
\begin{figure}[!h]
    \centering
    \includegraphics[keepaspectratio,scale=0.3]{/mnt/dev/Projects/DVIZ-Project/images/messy-picture-of-part-of-my-homelab}
...
\begin{figure}[!h]
    \centering
    \includegraphics[keepasprectratio,scale=0.5]{/mnt/dev/Projects/DVIZ-Project/images/product-piechart}
...
\begin{figure}[!h]
    \centering
    \includegraphics[keepaspectratio,scale=0.5]{/mnt/dev/Projects/DVIZ-Project/images/port-53-distribution-by-isp}
...
\begin{figure}[!h]
    \centering
    \includegraphics[keepaspectratio,scale=0.5]{/mnt/dev/Projects/DVIZ-Project/images/ssh-ports-that-are-remapped}
